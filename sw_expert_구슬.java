...
public class sw_expert_구슬 {
	...
	static void bfs(int x, int y, int[][] maps, int step, int counts) {
		...
		if (step == N) {
			//System.out.println(counts + " " + allBrick);

			return;
		}

		int[][] copymaps = deepCopy(maps);
...
//			if(min==Integer.MAX_VALUE) System.out.printf("#%d %d",tc,0);
//			else 
